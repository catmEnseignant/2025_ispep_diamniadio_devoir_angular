...
const studentSchema = z.object({
  numero_carte: z.string().min(1, "Le numéro de carte est obligatoire"),
...
const StudentForm = ({
  ...
  const form = useForm<StudentFormData>({
    ...
    defaultValues: {
      ...
      date_naissance: student?.date_naissance || undefined,
    },
  });
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[425px] bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 bg-opacity-80 backdrop-blur-md rounded-lg shadow-lg transition-transform duration-300 ease-in-out">
        <DialogHeader>
          <DialogTitle className="text-white">{title}</DialogTitle>
          <DialogDescription className="text-white/80">
            Remplissez les informations de l&apos;élève. Cliquez sur sauvegarder
            pour confirmer.
          </DialogDescription>
        </DialogHeader>
